...
| ---- | ---- | ------- | -------- | -------- | ------- | ------- |
| coin_id | BLOB |  | false |  | [coin_states](coin_states.md) |  |
...
| sqlite_autoindex_cat_coins_1 | PRIMARY KEY | PRIMARY KEY (coin_id) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| cat_asset_id | CREATE INDEX `cat_asset_id` ON `cat_coins` (`asset_id`) |
| sqlite_autoindex_cat_coins_1 | PRIMARY KEY (coin_id) |
