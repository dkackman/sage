...
pub fn run() {
    ...
    let builder = Builder::<tauri::Wry>::new()
        ...
        .commands(collect_commands![
            ...
            apps::lifecycle::list_installed_apps,
            apps::lifecycle::preview_app_zip,
            apps::lifecycle::preview_app_url,
            apps::lifecycle::install_app_zip,
            apps::lifecycle::install_app_url,
            apps::lifecycle::uninstall_app,
            apps::lifecycle::check_app_update,
            apps::lifecycle::download_app_update,
            apps::lifecycle::apply_app_update,
